...
const copyQuoteToClipboard = async (text: string, clipboardAvailable: boolean) => {
  ...
  // Fallback for browsers that block navigator.clipboard but still allow execCommand
  try {
